<template>
  <div>
    <span>
      本页面相关实现细节详见
      <a-button type="link" @click="openDocument">页面文档</a-button>
    </span>
    <a-drawer
      title="页面文档"
      :visible="open"
    ...
    >
      <a-typography>
        <a-title level="2">项目工程的搭建</a-title>
        <a-paragraph>
        ...
        <a-title level="2">数据可视化组件的选用与优化</a-title>
        <a-paragraph>
        ...
        <a-title level="2">文件下载与保存</a-title>
        <a-paragraph>
        ...
        <a-title level="2">桌面应用的打包与分发</a-title>
        <a-paragraph>
        ...
        <a-title level="2">静态资源的发布</a-title>
        <a-paragraph>
...
import { Button, Drawer, Typography } from 'ant-design-vue';
...
export default defineComponent({
  ...
  components: {
    ...
    ATitle: Typography.Title,
    AParagraph: Typography.Paragraph
  },
  setup() {
